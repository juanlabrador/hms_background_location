    ...
    companion object {
        ...
        fun saveCallbackDispatcher(context: Context, map: Map<Any, Any>) {
            ...
            sharedPreferences.edit()
                .putLong(ARG_CALLBACK_DISPATCHER,
                    map[ARG_CALLBACK_DISPATCHER] as Long)
                .apply()
        }
        ...
        fun getCallbackDispatcher(context: Context): Long {
            ...
            return sharedPreferences.getLong(ARG_CALLBACK_DISPATCHER, 0)
        }
        ...
        fun getSettings(context: Context): Map<Any, Any> {
            ...
            result[ARG_CALLBACK_DISPATCHER] = sharedPreferences.getLong(ARG_CALLBACK_DISPATCHER, 0)
